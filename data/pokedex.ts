export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	weeacriatemperature: {
		...
		gender: "N",
		baseStats: {hp: 69, atk: 10, def: 50, spa: 35, spd: 50, spe: 100},
		abilities: {0: "Flavor: Temperature"},
		heightm: 0.1,
		weightkg: 0.1,
		color: "Red",
		evos: ["Wackapacka"],
